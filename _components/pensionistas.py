...
def registrar_callbacks_pensionistas(app):
    @app.callback(
        [Output('fig0_pensionistas', 'figure'),
         Output('fig1_pensionistas', 'figure'),
         Output('fig2_pensionistas', 'figure'),
         Output('fig3_pensionistas', 'figure'),
         Output('fig4_pensionistas', 'figure')],
        Input('data-store', 'data')
    )
    def atualizar_graficos_pensionistas(data):
        ...
        df = df[df['Regime'] == 'Pensionistas'].copy()
